...
public class JWTTokenProvider {
    ...
    public Authentication getAuthentication(String userename, List<GrantedAuthority> authorities, HttpServletRequest request) {
        UsernamePasswordAuthenticationToken userPasswordAuthToken = new
                UsernamePasswordAuthenticationToken(userename, null, authorities);
